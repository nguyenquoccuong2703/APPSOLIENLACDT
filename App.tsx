...
import NotificationsTeacher from './android/DemoApp/Screen/Teacher/NotificationsTeacher';
import NotificationInput from './android/DemoApp/Screen/Teacher/NotificationInput';
    ...
    <UserProvider>
      <NavigationContainer>
        <Stack.Navigator initialRouteName="Login">
          ...
          />
          <Stack.Screen  
            name="NotificationsTeacher" 
            component={NotificationsTeacher} 
            options={{ title: 'Thông Báo' }}
          />
          <Stack.Screen  
            name="NotificationInput" 
            component={NotificationInput}
            options={{ title: 'Gửi Lớp Chủ Nhiệm' }} 
          />
          <Stack.Screen 
          name="NewsList" 
          component={NewsList} 
