...
const StudentScores: React.FC = () => {
    const route = useRoute<RouteProp<RootStackParamList, 'StudentScores'>>();
    ...
    const fetchScoresAndDetails = async () => {
        try {
            ...
            console.log('Fetched student data:', studentDataArray);
            ...
            if (studentDataArray.length > 0) {
                ...
                console.error('Student data is empty. Possible reasons: invalid student ID, data not available.');
                return;
            }
